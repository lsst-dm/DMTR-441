...
% using template at /Library/Frameworks/Python.framework/Versions/3.13/lib/python3.13/site-packages/docsteady/templates/tpr.latex.jinja2.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
By \hspace{0pt}\hspace{0pt}\hspace{0pt}\hspace{0pt}\hspace{0pt}design
the data model is captured and controlled in SDM Schemas as described in
https://dmtn-153.lsst.io/ . ~ This is in use for all data and allows
migration/control of data sets. For example see also
https://dmtn-227.lsst.io/\#making-the-schema,
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The outputs of the \hspace{0pt}"Ex" ellipticity \hspace{0pt}residuals
task are \hspace{0pt}stored in the `visit\_table` dataset. Load this
table:\\
\strut \\
...
\textbf{ Preconditions}:\\ b\textquotesingle\textquotesingle{}
...
â€‹ data transfers using the bulk data transfer service
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
We use the same repo/collection as in â€‹step 3:\\
butler = Butler(\textquotesingle dp2\_prep\textquotesingle,
collections={[}\textquotesingle LSSTCam/runs/DRP/20250417\_20250921/w\_2025\_49/DM-53545\textquotesingle{]})
...
with the processing for DR2. The hardware for each yearâ€™s processing
...
\end{tabular}
 Description \\
{\footnotesize
\hspace{0pt}Select a single visit+detector image, and re-run template
creation and \hspace{0pt}difference imaging for that image. Specify~
