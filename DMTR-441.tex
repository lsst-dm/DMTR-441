...
Final comment:\\None
  ...
  % end if not not executed - no steps if not executed
\paragraph{ LVV-T138 - Verify implementation of Bulk Download Service }\mbox{}\\
...
\textbf{ Preconditions}:\\ A large dataset (at least a few TB) must be available.\\
...
\begin{tabular}{p{4cm}p{12cm}}
\toprule
Step LVV-E3843-1 & Step Execution Status: \textbf{ Not Executed } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
...
\begin{tabular}{p{4cm}p{12cm}}
\toprule
Step LVV-E3844-1 & Step Execution Status: \textbf{ In Progress } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
...
% Note Steps "Not Executed" and with No Result are not shown in this report if the flag is passed
Detailed steps results LVV-R293-LVV-E3857-1319223132:\\
  {

\begin{tabular}{p{4cm}p{12cm}}
\toprule
Step LVV-E3857-1 & Step Execution Status: \textbf{ Not Executed } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
Delegate to CPP
...
\begin{tabular}{p{4cm}p{12cm}}
\toprule
Step LVV-E3858-1 & Step Execution Status: \textbf{ Not Executed } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
Delegate to CPP
...
Final comment:\\None
  ...
  % end if not not executed - no steps if not executed
\paragraph{ LVV-T60 - Verify implementation of Publishing predicted visit schedule }\mbox{}\\
...
\begin{tabular}{p{4cm}p{12cm}}
\toprule
Step LVV-E3994-2 & Step Execution Status: \textbf{ In Progress } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Next visit ~is not yet implemented. The query currently returns data
from the FBS on previously observed fields~
